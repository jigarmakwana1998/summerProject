    ...
    ***************************************************************************** */
    ...
    function mobileNetV1(x, params) {
        ...
        return Ze(function () {
            ...
            convPairParams.forEach(function (param, i) {
                ...
                if (layerIdx === 1) {
                    var _a = tr(out, [5, 1, 58], 3), preconv = _a[0], saveconv = _a[1], postconv = _a[2];
                    saveconv = saveconv.mul(255 / 6.0);
                    var convertedconv = saveconv.as2D(256, 256);
                    save_conv1 = convertedconv.arraySync();
                }
            });
            if (conv11 === null) {
    ...
    var SsdMobilenetv1 = /** @class */ (function (_super) {
        ...
        SsdMobilenetv1.prototype.getGrayScale = function () {
            return __awaiter(this, void 0, void 0, function () {
                var alpha, grayScaleImage;
                return __generator(this, function (_a) {
                    alpha = Hn([256, 256], 255);
                    grayScaleImage = Pr([this.save_conv1, this.save_conv1, this.save_conv1, alpha], 2);
